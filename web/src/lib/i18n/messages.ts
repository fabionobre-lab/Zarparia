...
const enGB: Messages = {
	...
	'landing.tryDemoSub': 'No account needed — explore a sample trip',
	'landing.consentText': 'By continuing you agree to the %TERMS% and %PRIVACY%.',
	...
	'authEmail.signUpSubmit': 'Request access',
	'authEmail.resetSubmit': 'Send reset link',
	'authEmail.working': 'Working…',
	'authEmail.linkCreateAccount': 'New here? Request access',
	...
	'authEmail.signupSuccess':
		"Request received — verify your email, and we'll let you in once your access is approved.",
...
const ptBR: Messages = {
	...
	'landing.tryDemo': 'Experimente a demo',
	'landing.tryDemoSub': 'Sem precisar de conta — explore uma viagem de exemplo',
	'landing.consentText': 'Ao continuar, você concorda com os %TERMS% e a %PRIVACY%.',
	...
	'authEmail.signUpSubmit': 'Solicitar acesso',
	'authEmail.resetSubmit': 'Enviar link de redefinição',
	'authEmail.working': 'Processando…',
	'authEmail.linkCreateAccount': 'Novo por aqui? Solicite acesso',
	...
	'authEmail.signupSuccess':
		'Pedido recebido — verifique seu e-mail e liberaremos seu acesso assim que for aprovado.',
